      ...
      <div style={{margin: "5rem"}}>
        ...
        <div style={{display: 'flex' , justifyContent: "space-evenly" , flexDirection: isMidScreen? "column-reverse": "row" , alignItems: 'center'}}>
          <div>
            ...
            <div>
              <Button> <a href="whatsapp://send?text=https://github.com/IamPiyushChauhan" data-action="share/whatsapp/share" target="_blank"><img src="/whatsapp.svg"/></a> </Button>
              <Button> <a href = "mailto:abc@example.com?subject = Resume Builder &body =whatsapp://send?text=https://github.com/IamPiyushChauhan"><img src="/email.svg"/></a></Button>
