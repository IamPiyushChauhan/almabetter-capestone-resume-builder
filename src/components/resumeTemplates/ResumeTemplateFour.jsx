...
function ResumeTemplateFour({data}) {
  ...
  return (
    ...
    <section className={`resume-four resume-template`}>
    <section className="head-session">
        <div className="head">
            <div className="avatar-and-name-section">
            
            <Avatar sx={{ width: smallScreen? 30 : midScreen? 40: 60, height: smallScreen? 30 : midScreen? 40: 60, marginLeft: "5%" , marginRight: "5%", backgroundColor: "var(--resume-color-three)" }} src= {data.profile_photo}> {data.fname[0]+data.lname[0]}</Avatar>
